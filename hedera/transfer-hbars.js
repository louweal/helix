...
async function main() {
    ...
    console.log("The current account balance is: " + accountBalance.hbars.toTinybars() + " tinybar.");
    ...
    console.log("The account balance after the transfer is: " + getNewBalance.hbars + " hbar.")
